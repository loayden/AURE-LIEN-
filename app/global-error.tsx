      ...
      >
        ...
        >
          ...
          >
            ...
            <p style={{ margin: 0, color: "rgba(255,255,255,0.22)", fontSize: 9, letterSpacing: "0.45em", textTransform: "uppercase" }}>
              Critical Error
            </p>
            <h1
              style={{
            ...
            >
              Application <em style={{ color: "#C6A962", fontStyle: "italic" }}>recovered</em>
            </h1>
            <p style={{ margin: "1rem 0 0", color: "rgba(255,255,255,0.36)", lineHeight: 1.7, letterSpacing: "0.04em" }}>
