...
function PremiumProductPage() {
    ...
    const id = params?.id;
    const product = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$productsData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].find((p)=>String(p._id) === id) || null;
    const p = product;
    const allMedia = p ? [
        ...p.images || [],
        ...p.media360 || []
...
_s2(PremiumProductPage, "nNZd6Jsk07TAlB/csMmPwgYAw+M=", false, function() {
    return [
...
//# sourceMappingURL=Documents_GitHub_AURE-LIEN-_50233694._.js.map