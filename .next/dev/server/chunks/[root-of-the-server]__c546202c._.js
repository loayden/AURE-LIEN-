...
"[project]/Documents/GitHub/AURE-LIEN-/app/api/cart/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    items = items.map((item)=>{
        const product = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$productsData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find((p)=>p._id === item.productId);
        return {
            ...item,
...
async function POST(req) {
    ...
    if (index !== -1) {
        ...
        const product = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$productsData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find((p)=>p._id === productId);
        const newItem = {
            _id: product?._id || '',
            userId,
            productId,
...
async function PUT(req) {
    ...
    const index = cart.findIndex((item)=>item.userId === userId && item.productId === productId && (item.size || null) === (size || null) && (item.color || null) === (color || null));
    if (index === -1) return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(req) {
    ...
    if (productId) {
        const index = cart.findIndex((item)=>item.userId === userId && item.productId === productId && (size === undefined || (item.size || null) === (size || null)) && (color === undefined || (item.color || null) === (color || null)));
        if (index === -1) return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Item not found'
        }, {
            status: 404
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c546202c._.js.map