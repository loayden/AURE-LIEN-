...
"[project]/Documents/GitHub/AURE-LIEN-/lib/email/templates/order-confirmation.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;">
          ...
          <tr>
            <td style="padding:32px 0;">
              <a href="${__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$email$2f$sender$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SITE_URL"]}/orders" style="display:inline-block;padding:14px 32px;background-color:transparent;border:1px solid #C6A75E;color:#C6A75E;text-decoration:none;font-size:12px;letter-spacing:0.2em;text-transform:uppercase;">Track Your Order</a>
            </td>
          </tr>
          <!-- Footer -->
          <tr>
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$email$2f$sender$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/GitHub/AURE-LIEN-/lib/email/sender.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$email$2f$templates$2f$order$2d$confirmation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/GitHub/AURE-LIEN-/lib/email/templates/order-confirmation.ts [app-route] (ecmascript)");
...
async function POST(req) {
    try {
        ...
        if (!customer || !customer.email || !customer.phone || !Array.isArray(products) || products.length === 0 || typeof total !== "number" || !status || !createdAt) {
        ...
        const ordersJson = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$orderStorage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOrdersJson"])();
        ...
        const { userId, isNew } = auth?.userId ? {
            userId: auth.userId,
            isNew: false
        } : (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$userSession$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOrCreateUserId"])(req);
        const ordersJsonOrder = {
            id: body.id || (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])(),
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$orderStorage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setOrdersJson"])(ordersJson);
        // 2) Save to ordersData (detailed format for admin/analytics)
        const ordersData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$orderStorage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOrdersDataJson"])();
        const productsDetailed = products.map((p)=>{
            const found = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$productsData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find((x)=>String(x._id) === String(p._id));
            return {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$orderStorage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setOrdersDataJson"])(ordersData);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$email$2f$sender$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendEmailAsync"])({
            ...
            html: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$email$2f$templates$2f$order$2d$confirmation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOrderConfirmationEmailHtml"])({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0shdzab._.js.map