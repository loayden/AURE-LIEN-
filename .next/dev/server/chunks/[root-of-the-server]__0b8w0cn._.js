...
"[project]/Documents/GitHub/AURE-LIEN-/app/api/orders/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function enrichItems(items) {
    return items.map((item)=>{
        const product = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$productsData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find((p)=>String(p._id) === String(item.productId));
        return {
...
function findExistingPendingOrder(orders, userId) {
    return orders.find((o)=>o.userId === userId && o.status === "pending");
}
/** Normalize order to the shape expected by the orders page (_id, userId, items, totalPrice, status, createdAt). */ function normalizeOrder(raw) {
    ...
    const items = enrichItems(rawItems.map((p)=>({
...
async function DELETE(req) {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$orderStorage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setOrdersJson"])(filtered);
    const res = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        success: true
    }, {
        status: 200
...
async function POST(req) {
    try {
        ...
        if (existingOrder) {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$orderStorage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setOrdersJson"])(orders);
            const res = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                orders: [
                    existingOrder
                ]
        ...
        const newOrder = {
            _id: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])(),
            userId,
            items: enrichedItems,
            totalPrice,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0b8w0cn._.js.map