...
async function POST(req) {
    try {
        ...
        const hasCustomerName = Boolean(customerInfo.name) || Boolean(customerInfo.firstName) || Boolean(customerInfo.lastName);
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$orderStorage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["appendOrder"])(newOrder);
...
async function GET(req) {
    try {
        ...
        let orders = [];
        try {
            orders = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$AURE$2d$LIEN$2d2f$lib$2f$orderStorage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOrdersJson"])();
        } catch (readError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__00j1mjm._.js.map